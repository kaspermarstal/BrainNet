...
## Update
PLEASE NOTE: Applying a giant CNN to voxel-wise segmentation is not an efficient approach. This repo serves as an example on how to run experiments on Google Cloud, not how to segment brian images.
